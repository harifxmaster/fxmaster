  ...
  return (
    <View style={styles.mainContainer}>
      <View style={styles.topLayer}>
        <View style={{flexDirection:"row",justifyContent:"space-between",marginTop:actuatedNormalize(65),marginHorizontal:actuatedNormalize(15)}}>
        <Pressable
          
          onPress={() => navigation.goBack()}>
          <Ionicons color={Colors.black} name="arrow-back-outline" size={24} />
        </Pressable>
        <TextComponent style={{color:Colors.black,fontSize:actuatedNormalize(16), fontFamily:Fonts.Rubik_Regular}}>Beneficiary</TextComponent>
        <Pressable>
              ...
              onPress={() => navigation.push("Confirmation",{
                ...
                <View style={{flexDirection: 'row', alignItems: 'center'}}>
                  ...
                  <View style={{paddingLeft: actuatedNormalize(18)}}>
                    <TextComponent style={{color: Colors.black, fontSize:actuatedNormalize(14), fontFamily:Fonts.Rubik_Medium}}>
                      {item.title}
                    </TextComponent>
                    <TextComponent
                      style={{
                    ...
                    <TextComponent style={{color: "#545F7A", fontFamily:Fonts.Rubik_Regular,
                        fontSize:actuatedNormalize(12)}}>
                      {item.number}
                    </TextComponent>
                  </View>
                ...
                <View style={{flexDirection:"row"}}>
                  <Image
                  source={item.flag}
                  style={{height:actuatedNormalize(24),width:actuatedNormalize(24),marginRight:actuatedNormalize(30)}}
                  />
