...
const OnBoardingScreenFirst = props => {
  ...
  return (
    <View style={styles.mainContainer}>
      ...
      {/* <Image
        ...
        /> */}
      <Image source={PngLocation.Undraw} style={styles.headerImage} />

      <View style={styles.dotContainer}>
        <View
          style={
            onBoardingFirst ? styles.activeDot : styles.inActiveDot
          }></View>
        <View style={{width: actuatedNormalize(8)}}></View>
        <View
          style={
            onBoardingSecond ? styles.activeDot : styles.inActiveDot
          }></View>
      </View>
      {onBoardingFirst ? (
