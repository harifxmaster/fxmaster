                    ...
                    renderCustomizedButtonChild={(selectedItem, index) => {
                        return (
                            <View style={styles.dropdown3BtnChildStyle}>
                                {selectedOption.toLowerCase() == "select title" || selectedOption.toLowerCase() == "purpose of account" || selectedOption.toLowerCase() == "destination country" || selectedOption.toLowerCase() == "country of residence" || selectedOption.toLowerCase() == "nationality" ?
                                    <Text style={styles.dropdown3BtnTxt}>{selectedItem ? selectedItem.name : selectedOption}</Text>
                                    :
                                    selectedOption.toLowerCase() == "occupation" ?
                                        <Text style={styles.dropdown3BtnTxt}>{selectedItem ? selectedItem.occupation : selectedOption}</Text>
                                        :
                                        ""}

                                <FontAwesome name="chevron-down" color={Colors.lightGrey} size={13} />
                            </View>
                        );
                    }}
                        ...
                        return (
                            <View style={styles.dropdown3RowChildStyle}>
                                ...
                                {selectedOption.toLowerCase() == "select title" || selectedOption.toLowerCase() == "purpose of account" || selectedOption.toLowerCase() == "destination country" || selectedOption.toLowerCase() == "country of residence" || selectedOption.toLowerCase() == "nationality" ?
                                    ...
                                    <TextComponent style={styles.listItem}>{item.name}</TextComponent>
                                    :
                                    selectedOption.toLowerCase() == "occupation" ?
                                        <TextComponent style={styles.listItem}>{item.occupation}</TextComponent>
